...
public class LDAPManager {
    ...
    private static String getLdapCredentials() {
        String credentials = System.getProperty("ldap.security.credentials");
        if (credentials == null) {
            credentials = System.getenv("LDAP_SECURITY_CREDENTIALS");
        }
        if (credentials == null) {
            credentials = "secret";
        }
    ...
    protected Hashtable<Object, Object> createEnv() {
        ...
        env.put(Context.SECURITY_CREDENTIALS, getLdapCredentials());
